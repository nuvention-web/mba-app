...
<div *ngIf="!editing">
    <div class="form-group">
        ...
        <div *ngIf="!IsTextareaEmpty()" (click)="edit(value)" (focus)="edit(value);" [style.height]="minheight" tabindex="0" [ngClass]="disabled == 'true' ? 'inline-no-edit' : 'inline-edit'"><div *ngFor="let i of _display" [innerHTML]="i"></div></div>
    </div>
</div>`,
        styles: [
