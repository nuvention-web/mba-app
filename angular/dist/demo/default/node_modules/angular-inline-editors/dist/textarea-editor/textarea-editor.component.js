...
let TextAreaEditorComponent = class TextAreaEditorComponent {
    ...
    set value(v) {
        if (v !== this._value) {
            this._value = v;
            if (this.value != null) {
                this.display = this._value.split("\n");
            }
            this.onChange(v);
        }
    }
...
<div *ngIf="!editing">
    <div class="form-group">
        ...
        <div *ngIf="!IsTextareaEmpty()" (click)="edit(value)" (focus)="edit(value);" [style.height]="minheight" tabindex="0" [ngClass]="disabled == 'true' ? 'inline-no-edit' : 'inline-edit'"><div ngFor="let line of display"> {{line}}&nbsp;</div>
    </div>
</div>`,
        styles: [
