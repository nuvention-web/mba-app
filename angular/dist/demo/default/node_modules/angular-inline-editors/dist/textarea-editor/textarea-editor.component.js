...
<div *ngIf="!editing">
    <div class="form-group">
        ...
        <div *ngIf="!IsTextareaEmpty()" (click)="edit(value)" (focus)="edit(value);" [style.height]="minheight" tabindex="0" [ngClass]="disabled == 'true' ? 'inline-no-edit' : 'inline-edit'"><p *ngFor="let i of _display">{{i}}</p></div>
    </div>
</div>`,
        styles: [
