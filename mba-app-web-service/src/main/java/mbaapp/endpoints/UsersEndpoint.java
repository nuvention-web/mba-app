...
public class UsersEndpoint extends EndpointBase{
    ...
    @PostMapping("/{userEmail}/tasks")
    @CrossOrigin
    @ApiOperation(value = "Add a task ")
    public ResponseEntity<String> addTask(@RequestBody AddTaskRequest taskRequest, @PathVariable String userEmail) {
    ...
    @DeleteMapping("/{userEmail}/tasks/{taskID}")
    @CrossOrigin
    @ApiOperation(value = "Add a task ")
    public ResponseEntity<String> deleteTask(@PathVariable String userEmail, @PathVariable String taskID) {
    ...
    public ResponseEntity<String> updateTask(@PathVariable String userEmail, @PathVariable String taskID, @RequestBody AddTaskRequest addTaskRequest) {
