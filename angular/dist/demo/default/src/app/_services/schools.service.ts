...
export class SchoolsService {
    ...
    getAllEssays() {
        return this.http.get("https://mba-application.appspot.com/mba/users/john.doe@gmail.com/essays").map((response:Response) => response.json());
    }

    deleteEssayDraft(schoolName:string, essayID:string, draftID:string) {
        return this.http.delete("https://mba-application.appspot.com/mba/users/john.doe@gmail.com/school/" + schoolName + "/essay/" + essayID + "/draft/" + draftID);
    }
    ...
    uploadFile(file, schoolName:string, essayID:string) {
        ...
        return this.http.post("https://mba-application.appspot.com/mba/users/john.doe@gmail.com/school/" + schoolName + "/essay/" + essayID+"/upload/draft", formData)
    }
