...
let TextAreaEditorComponent = class TextAreaEditorComponent {
    ...
    assign() {
        if (this._value != null) {
            this._display = this._value.split('\n');
...
TextAreaEditorComponent = __decorate([
    ...
    <div class="input-group">
        <textarea [id]="id" #textareaEditorControl [(ngModel)]="value" [class.is-invalid]="textareaReqflag" style="word-wrap: break-word;"
            style="font-size: 20px"[maxlength]="stringlength" [style.height]="maxheight" class="form-control" wrap="hard">
            </textarea>
    </div>
...
<div *ngIf="!editing">
    <div class="form-group">
        ...
        <div *ngIf="!IsTextareaEmpty()" (click)="edit(value)" (focus)="edit(value);" [style.height]="minheight" tabindex="0" [ngClass]="disabled == 'true' ? 'inline-no-edit' : 'inline-edit'"><p *ngFor="let i of _display" [innerHTML]="i"></p></div>
    </div>
</div>`,
        styles: [
            '.col-form-label { padding-bottom: 0px !important; }',
            '.inline-edit { cursor: pointer; width: auto; text-decoration: none; border-bottom: #007bff dashed 1px;}',
            '.inline-no-edit { cursor: not-allowed; width: auto; text-decoration: none; border-bottom: #959596 dashed 1px;}',
            '.inline-edit-empty{ cursor: pointer; width: auto; color: #b9b8b8; text-decoration: none; border-bottom: red dashed 1px;}'
        ],
